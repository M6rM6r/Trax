...
export const SortableDashboardCard = memo(function SortableDashboardCard({
  ...
  return (
    ...
    >
      <button
        className="absolute top-3 left-3 z-20 p-1 rounded-md bg-slate-700/60 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing touch-none"
      ...
      <Link
        ...
        className="block rounded-xl border border-slate-700/50 bg-slate-800 p-5 transition-all duration-200 hover:border-slate-600 hover:bg-slate-700/50 hover:scale-[1.01] active:scale-[0.99]"
      >
            ...
            <Tooltip.Provider delayDuration={200}>
              <Tooltip.Root>
                ...
                <Tooltip.Portal>
                  <Tooltip.Content
                    sideOffset={6}
                    className="rounded-lg bg-slate-700 text-white text-xs px-3 py-1.5 shadow-lg z-50"
                  >
