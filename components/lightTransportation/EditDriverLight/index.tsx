...
const Index = ({
  ...
  const handleStepSubmit = async (step: number, values: any) => {
    ...
    if (step === 1) {
      ...
      serviceFormData.append("vehicle_type", "light_transportation");
      ...
      if (values.numberOfCabins) {
        serviceFormData.append("light_transportation_type", values.numberOfCabins);
      }
  ...
  return (
    <FormStepper
      ...
      initialValues={{
        ...
        numberOfCabins: profileData.vehicle_data?.light_transportation_type_key || "",
        // step 2: Documents
      ...
      onSubmit={async (values, { setSubmitting }) => {
        try {
          // Step 3: Check WASL Validity (but always proceed regardless of result)
