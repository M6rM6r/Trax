...
interface FuelAppPercentageProps {
  app_percentage: string | number;
  type: string;
}

/**
 * Fuel (Outages) service AppPercentage component (SIMPLE)
 * Just percentage input with save button - no dropdown, no checkboxes
 */
const FuelAppPercentage = ({
  app_percentage,
  type,
}: FuelAppPercentageProps) => {
...
export default FuelAppPercentage;
