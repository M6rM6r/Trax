...
interface LightTransportationPricesDayProps {
...
const LightTransportationPricesDay = ({
  is_coming_soon,
  is_hidden,
  price_per_km,
  price_per_minute,
  ...
  type,
  service_settings,
}: LightTransportationPricesDayProps) => {
...
export default LightTransportationPricesDay;
