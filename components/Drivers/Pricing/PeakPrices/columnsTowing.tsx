...
export const getColumnsTowing = (existingPeakTimes: PeakTimeData[], fontasUnitLabel?: string, serviceName?: string): ColumnDef<PeakTimeData>[] => [
  {
    accessorKey: "time",
    header: ({ column }) => (
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className=" flex items-center gap-3">
        <EditPeakPrice data={row.original} serviceName="towing" fontasUnitLabel={fontasUnitLabel} existingPeakTimes={existingPeakTimes} />
