...
const Index = ({
  ...
  return (
    <FormStepper
      initialValues={{
        // step 1
        fontas_type: profileData.vehicle_data.fontas_unit.type,
        fontas_unit_id: profileData.vehicle_data.fontas_unit.id,
        fontas_unit_id_dummy: `${profileData.vehicle_data.fontas_unit.unit}/${profileData.vehicle_data.fontas_unit.value}`,
        // step 2
      ...
      onSubmit={async (values, { setSubmitting }) => {
        try {
          ...
          serviceFormData.append("vehicle_type", "fontas");
          serviceFormData.append("fontas_unit_id", values.fontas_unit_id.toString());

          // Add fontas type (convert Arabic to enum)
          const fontasType = values.fontas_type === "صالح للشرب" ? "valid" : "invalid";
          serviceFormData.append("fontas_type", fontasType);
