        ...
        <div className="space-y-3">
          {data.map((item) => {
            ...
            return (
              <div
                key={item.name}
                className="flex items-center justify-between p-3 rounded-xl border border-gray-200 dark:border-slate-700 hover:shadow-md hover:scale-[1.02] transition-all duration-200 bg-white dark:bg-slate-800 cursor-default"
              >
