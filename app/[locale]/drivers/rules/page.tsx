...
import { RulesResponse } from "@/lib/types/responseTypes";
const Page = async ({
  params,
  searchParams,
}: {
  ...
  const data = await fetcher<RulesResponse>(`/rules?${urlParams.toString()}`);
  //
