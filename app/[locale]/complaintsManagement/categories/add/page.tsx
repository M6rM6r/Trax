...
import { validationForCategory } from "@/lib/types/validationTypes";
  ...
  return (
    <MainLayout showSidebar={false}>
      ...
      <Formik<{
        ...
        validationSchema={validationForCategory}
        ...
        {(props) => (
          <Form className="flex flex-col gap-5 p-4 border border-gray200 rounded-12 bg-white">
            <div className="flex items-center justify-between flex-wrap gap-5">
              <h2 className="text-20 text-textMain font-[700]">انشىء تصنيف</h2>
              <Button
                variant={"primary"}
                type="submit"
            ...
            <div className="flex flex-col gap-5 p-4 border border-gray200 rounded-6">
              <p className="text-16 text-textMain font-[600]">التصنيف</p>
              <div className=" grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <CustomInput
                  type="text"
                  name="title_en"
                  placeholder="اسم التصنيف باللغة الانجليزية"
