...
import { ColorsResponse } from "@/lib/types/responseTypes";
const Page = async ({
  params,
  searchParams,
}: {
  ...
  const data = await fetcher<ColorsResponse>(`/colors?${urlParams.toString()}`);
  //
      ...
      <DataTable
        ...
        topComponent={
          <Button variant="primary" size="lg" asChild>
            <Link
              href={`/${params.locale}/vehicles/colors/add`}
