    ...
    <MainLayout showSidebar={false}>
      ...
      <Formik<{
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          try {
            const response = await fetcherClient<any>("/colors", {
              method: "POST",
              body: formdata,
            });
        ...
        {(props) => (
          <Form className="flex flex-col gap-5 p-4 border border-gray200 rounded-12 bg-white">
            <div className="flex items-center justify-between flex-wrap gap-5">
              <h2 className="text-20 text-textMain font-[700]">إنشاء لون</h2>
              <Button
                variant={"primary"}
                type="submit"
            ...
            <div className="flex flex-col gap-5 p-4 border border-gray200 rounded-6">
              <p className="text-16 text-textMain font-[600]">تفاصيل اللون</p>
